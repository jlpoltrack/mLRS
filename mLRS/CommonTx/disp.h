...
// so we draw always full
    ...
    gdisp_puts(s);
    gdisp_setcurX(85);
    power = (TRANSMIT_USE_ANTENNA1) ? sx.RfPower_dbm() : sx2.RfPower_dbm();
...
char s[32];
    ...
    gdisp_puts(s);
    gdisp_setcurX(80 + 5);
    stoBCDstr((TRANSMIT_USE_ANTENNA1) ? sx.ReceiverSensitivity_dbm() : sx2.ReceiverSensitivity_dbm(), s);
    gdisp_puts(s);
    gdisp_puts(" dB");
    ...
    gdisp_puts("Power");
    gdisp_setcurX(40);
    stoBCDstr((TRANSMIT_USE_ANTENNA1) ? sx.RfPower_dbm() : sx2.RfPower_dbm(), s);
    gdisp_puts(s);
    gdisp_setcurX(80);
