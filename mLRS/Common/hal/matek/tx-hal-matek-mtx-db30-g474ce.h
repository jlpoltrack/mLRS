...
#define FAN_TIMx                  TIM4
#define FAN_TIM_CHANNEL           LL_TIM_CHANNEL_CH2
#define FAN_IO_AF                 IO_AF_2

void fan_gpio_init(void) { gpio_init_af(FAN_IO, IO_MODE_OUTPUT_ALTERNATE_PP, FAN_IO_AF, IO_SPEED_DEFAULT); }
void fan_tim_clk_enable(void) { LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_TIM4); }
void fan_set_compare(uint32_t compare_value) { LL_TIM_OC_SetCompareCH2(FAN_TIMx, compare_value); }
