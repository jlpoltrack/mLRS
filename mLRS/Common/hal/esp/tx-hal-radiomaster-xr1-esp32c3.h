...
//-------------------------------------------------------
// ESP32, ELRS RadioMaster XR1 Receiver as TX, can only do SiK
//-------------------------------------------------------
// same board as rx-hal-radiomaster-xr1-esp32c3.h, but as a Tx module.
// com is on USB, the C3's USB-Serial-JTAG pads IO_P18, IO_P19, so no
// second uart is needed for the CLI
...
// com is on USB, so no UARTC, it becomes a dummy port
