...
typedef enum {
  ...
  // C5 has no SYSCFG (SBS replaces it), the EXTI source mux lives in the EXTI peripheral itself
  #define _LL_EXTI_APPEND(x)  LL_EXTI_GPIO ## x
#else
...
// C5 splits the single pending register into a rising (RPR1) and a falling (FPR1) one,
