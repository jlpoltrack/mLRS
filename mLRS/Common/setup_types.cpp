...
cvt_to_sx_fhss_frequency_band(uint8_t setup_frequency_band) {
  ...
  case SETUP_FREQUENCY_BAND_915_MHZ_FCC:
    return SX_FHSS_CONFIG_FREQUENCY_BAND_915_MHZ_FCC;
  case SETUP_FREQUENCY_BAND_868_MHZ:
    return SX_FHSS_CONFIG_FREQUENCY_BAND_868_MHZ;
  case SETUP_FREQUENCY_BAND_433_MHZ:
    return SX_FHSS_CONFIG_FREQUENCY_BAND_433_MHZ;
  case SETUP_FREQUENCY_BAND_70_CM_HAM:
    return SX_FHSS_CONFIG_FREQUENCY_BAND_70_CM_HAM;
  case SETUP_FREQUENCY_BAND_866_MHZ_IN:
    return SX_FHSS_CONFIG_FREQUENCY_BAND_866_MHZ_IN;
...
cvt_to_setup_frequency_band(uint8_t sx_fhss_frequency_band) {
  ...
  case SX_FHSS_CONFIG_FREQUENCY_BAND_2P4_GHZ:
    return SETUP_FREQUENCY_BAND_2P4_GHZ;
  case SX_FHSS_CONFIG_FREQUENCY_BAND_915_MHZ_FCC:
    return SETUP_FREQUENCY_BAND_915_MHZ_FCC;
  case SX_FHSS_CONFIG_FREQUENCY_BAND_868_MHZ:
    return SETUP_FREQUENCY_BAND_868_MHZ;
  case SX_FHSS_CONFIG_FREQUENCY_BAND_433_MHZ:
    return SETUP_FREQUENCY_BAND_433_MHZ;
  case SX_FHSS_CONFIG_FREQUENCY_BAND_70_CM_HAM:
    return SETUP_FREQUENCY_BAND_70_CM_HAM;
  case SX_FHSS_CONFIG_FREQUENCY_BAND_866_MHZ_IN:
    return SETUP_FREQUENCY_BAND_866_MHZ_IN;
  default:
    while (1) {
    }
  }
