...
SX_FHSS_CONFIG_FREQUENCY_BAND_ENUM cvt_to_sx_fhss_frequency_band(uint8_t setup_frequency_band)
{
    switch (setup_frequency_band) {
        case SETUP_FREQUENCY_BAND_2P4_GHZ: return SX_FHSS_CONFIG_FREQUENCY_BAND_2P4_GHZ;
        case SETUP_FREQUENCY_BAND_915_MHZ_FCC: return SX_FHSS_CONFIG_FREQUENCY_BAND_915_MHZ_FCC;
        case SETUP_FREQUENCY_BAND_868_MHZ: return SX_FHSS_CONFIG_FREQUENCY_BAND_868_MHZ;
        case SETUP_FREQUENCY_BAND_433_MHZ: return SX_FHSS_CONFIG_FREQUENCY_BAND_433_MHZ;
        case SETUP_FREQUENCY_BAND_70_CM_HAM: return SX_FHSS_CONFIG_FREQUENCY_BAND_70_CM_HAM;
...
bool is_dual_band_frequency(uint8_t setup_frequency_band)
{
    return (setup_frequency_band == SETUP_FREQUENCY_BAND_868_MHZ_PLUS_2P4_GHZ ||
            setup_frequency_band == SETUP_FREQUENCY_BAND_915_MHZ_FCC_PLUS_2P4_GHZ);
}


SX_FHSS_CONFIG_FREQUENCY_BAND_ENUM cvt_to_sx2_fhss_frequency_band(uint8_t setup_frequency_band)
{
    switch (setup_frequency_band) {
